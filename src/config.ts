...
export const dbUri = {
  development: 'mongodb://localhost:27017/sprint-sync',
  // explicitDbUri || buildMongoUri(dbName, 'localhost'),
  ...
  // explicitDbUri || process.env.DB_URI || 'mongodb://localhost:27017/test',
};
